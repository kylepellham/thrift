...
class t_cr_generator : public t_oop_generator
{
  ...
  void generate_cr_simple_constructor(t_rb_ofstream& out, t_struct* tstruct);
  void generate_cr_simple_exception_constructor(t_rb_ofstream& out, t_struct* tstruct);
...
string t_cr_generator::render_includes()
{
  ...
  for (auto include : includes)
  {
    ...
    string included_require_prefix = cr_namespace_to_path_prefix(included->get_namesapce("cr"));
